		...
		'oneSimpleTablePagination': function(userConfigurations) {
			...
			return this.each(function() {
				...
				function createPaginationElements() {
					var paginationHTML = "";
					paginationHTML += "<div id='tablePagination' style='text-align: center; border-top: solid 5px #0033CC; padding-top: 5px; padding-bottom: 5px;'>";
					...
					paginationHTML += "Page";
					paginationHTML += "<input id='tablePagination_currPage' type='input' value='" + currPageNumber + "' size='1' disabled align='center'<x></x>>";
